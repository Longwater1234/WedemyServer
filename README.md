...
Click to view [API documentation](https://github.com/Longwater1234/WedemyServer/wiki/API-Documentation) for this
project, auto-generated by [widdershins](https://www.npmjs.com/package/widdershins) library.
...
X-AUTH-TOKEN; see SecurityConfig.java. 